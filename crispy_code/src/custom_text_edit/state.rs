...
pub type TextEditUndoer = nih_plug_egui::egui::util::undoer::Undoer<(CCursorRange, String)>;
...
///
/// let mut output = nih_plug_egui::egui::TextEdit::singleline(&mut text).show(ui);
///
